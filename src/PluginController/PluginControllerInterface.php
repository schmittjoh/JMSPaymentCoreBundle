...
interface PluginControllerInterface
{
     ...
     */
    public function approve(int $paymentId, float $amount): Result;
     ...
     * @return Result
     */
    public function approveAndDeposit(int $paymentId, float $amount): Result;
     ...
     */
    public function createDependentCredit(int $paymentId, float $amount): CreditInterface;
     ...
     * is VALID.
     */
    public function createIndependentCredit(int $paymentInstructionId, float $amount): CreditInterface;
     ...
     */
    public function createPayment(int $paymentInstructionId, float $amount): PaymentInterface;
     ...
     */
    public function credit(int $creditId, float $amount): Result;
     ...
     */
    public function deposit(int $paymentId, float $amount): Result;
     ...
     */
    public function getCredit(int $creditId): CreditInterface;
     ...
     */
    public function getPayment(int $paymentId): PaymentInterface;
     ...
     */
    public function reverseApproval(int $paymentId, float $amount): Result;
     ...
     * - set reason code to PluginInterface::REASON_CODE_TIMEOUT
     */
    public function reverseCredit(int $creditId, float $amount): Result;
     ...
     * - keep all amounts in Payment, and PaymentInstruction unchanged
     */
    public function reverseDeposit(int $paymentId, float $amount): Result;
