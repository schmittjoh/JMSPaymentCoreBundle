...
abstract class AbstractPlugin implements PluginInterface
{
    ...
    public function approve(FinancialTransactionInterface $transaction, bool $retry): void
    {
        throw new FunctionNotSupportedException('approve() is not supported by this plugin.');
    }

    public function approveAndDeposit(FinancialTransactionInterface $transaction, bool $retry): void
    {
     ...
     * {@inheritdoc}
     */
    public function checkPaymentInstruction(PaymentInstructionInterface $instruction): void
    {
        throw new FunctionNotSupportedException('checkPaymentInstruction() is not supported by this plugin.');
    }

    public function credit(FinancialTransactionInterface $transaction, bool $retry): void
    {
        throw new FunctionNotSupportedException('credit() is not supported by this plugin.');
    }

    public function deposit(FinancialTransactionInterface $transaction, bool $retry): void
    {
    ...
    public function reverseApproval(FinancialTransactionInterface $transaction, bool $retry): void
    {
        throw new FunctionNotSupportedException('reverseApproval() is not supported by this plugin.');
    }

    public function reverseCredit(FinancialTransactionInterface $transaction, bool $retry): void
    {
        throw new FunctionNotSupportedException('reverseCredit() is not supported by this plugin.');
    }

    public function reverseDeposit(FinancialTransactionInterface $transaction, bool $retry): void
    {
        throw new FunctionNotSupportedException('reverseDeposit() is not supported by this plugin.');
    }

    public function setDebug($boolean): void
    {
     ...
     * {@inheritdoc}
     */
    public function validatePaymentInstruction(PaymentInstructionInterface $instruction): void
    {
