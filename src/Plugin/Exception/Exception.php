...
class Exception extends PaymentBundleException
{
    ...
    public function setFinancialTransaction(FinancialTransactionInterface $transaction): void
    {
    ...
    public function setPaymentInstruction(PaymentInstructionInterface $instruction): void
    {
