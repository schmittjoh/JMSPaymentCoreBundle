...
interface PluginInterface
{
     ...
     * authorized.
     */
    public function approve(FinancialTransactionInterface $transaction, bool $retry);
     ...
     * another transaction.
     */
    public function approveAndDeposit(FinancialTransactionInterface $transaction, bool $retry);
     ...
     */
    public function credit(FinancialTransactionInterface $transaction, bool $retry);
     ...
     */
    public function deposit(FinancialTransactionInterface $transaction, bool $retry);
     ...
     */
    public function reverseApproval(FinancialTransactionInterface $transaction, bool $retry);
     ...
     *                              not supported by the payment backend system
     */
    public function reverseCredit(FinancialTransactionInterface $transaction, bool $retry);
     ...
     *                              not supported by the payment backend system
     */
    public function reverseDeposit(FinancialTransactionInterface $transaction, bool $retry);
     ...
     * indirectly.
     */
    public function processes(string $paymentSystemName): bool;
