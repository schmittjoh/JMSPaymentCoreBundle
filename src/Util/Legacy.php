...
class Legacy
{
     ...
     */
    public static function supportsFormTypeClass(): bool
    {
     ...
     */
    public static function supportsOptionsResolverSetAllowedTypesAsArray(): bool
    {
        return !method_exists('Symfony\Component\OptionsResolver\OptionsResolver', 'setDefined');
    }
     ...
     */
    public static function formChoicesAsValues(): bool
    {
     ...
     */
    public static function needsChoicesAsValuesOption(): bool
    {
     ...
     */
    public static function supportsSecureRandom(): bool
    {
     ...
     */
    public static function isOldPathExecutionContext(): bool
    {
     ...
     */
    public static function supportsRequestService(): bool
    {
