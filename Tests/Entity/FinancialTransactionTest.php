...
class FinancialTransactionTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $transaction = new FinancialTransaction;
        $credit = $this->createMock('JMS\Payment\CoreBundle\Model\CreditInterface');
    ...
    {
        $transaction = new FinancialTransaction;
        $extendedData = $this->createMock('JMS\Payment\CoreBundle\Model\ExtendedDataInterface');
    ...
    {
        $transaction = new FinancialTransaction;
        $payment = $this->createMock('JMS\Payment\CoreBundle\Model\PaymentInterface');
